        ...
        <div class="container">
            ...
            <div class="service_wrapper">
                @foreach($services as $k=>$services)
                    @if($k ==0 || $k%3 == 0)
                        <div class="row {{ ($k !=0)?  'borderTop' : ''}} {{($k>2) ? 'marginTop' : ''}}">
                    @endif
                ...
                <div class="col-lg-8 wow fadeInLeft delay-06s">
                    <div class="form">
                        <form action="/" method="post">
                            ...
                            <textarea name="text" class="input-text text-area" value="" placeholder="text" cols="0" rows="0" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;"></textarea>
